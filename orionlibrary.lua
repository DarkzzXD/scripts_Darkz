	...
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(28, 1, 31), 0, 10), {
			...
			SetProps(MakeElement("Label", NotificationConfig.Name, 15), {
				...
				Font = Enum.Font.PermanentMarkerer,
				Name = "Title"
			}),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", LocalPlayer.DisplayName, WindowConfig.HidePremium and 14 or 13), {
				...
				Font = Enum.Font.PermanentMarkerer, --PermanantMark
	...
	function TabFunction:MakeTab(TabConfig)
		...
		if FirstTab then
			...
			TabFrame.Title.Font = Enum.Font.PermanentMarkerer
